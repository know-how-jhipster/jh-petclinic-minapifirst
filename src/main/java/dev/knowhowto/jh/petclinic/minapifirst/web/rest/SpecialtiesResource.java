...
import dev.knowhowto.jh.petclinic.minapifirst.repository.SpecialtiesRepository;
import dev.knowhowto.jh.petclinic.minapifirst.service.SpecialtiesService;
import dev.knowhowto.jh.petclinic.minapifirst.service.dto.SpecialtiesDTO;
import dev.knowhowto.jh.petclinic.minapifirst.web.rest.errors.BadRequestAlertException;
import tech.jhipster.web.util.HeaderUtil;
import tech.jhipster.web.util.ResponseUtil;

/**
 * REST controller for managing {@link dev.knowhowto.jh.petclinic.minapifirst.domain.Specialties}.
 */
@RestController
@RequestMapping("/api")
